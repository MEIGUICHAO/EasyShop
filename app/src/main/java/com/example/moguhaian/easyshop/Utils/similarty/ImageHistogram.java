package com.example.moguhaian.easyshop.Utils.similarty;
...
//	}
//
//	private float[] filter(Bitmap src) {
...
//	}
//
//	private int[] getRGB(Bitmap image, int x, int y, int width, int height, int[] pixels) {
//		int type = image.g();
