...
public abstract class Base1688Fragment extends BaseFragment<Ali1688Vu, Ali1688Biz> implements LoadFinishListener, LoalMethodListener {

    public int[] items = {R.string.go1688, R.string.one_piece_send, R.string.nextpage, R.string.one_click_shop, R.string.login, R.string.pics_space, R.string.get_pics_space_pic, R.string.publish_scene, R.string.filter_word, R.string.office_publish
...
//    https://s.1688.com/selloffer/offer_search.htm?descendOrder=true&sortType=va_rmdarkgmv30rt&uniqfield=userid&keywords=%CE%A2%B2%A8%C2%AF%D6%C3%CE%EF%BC%DC&netType=1%2C11&n=y&from=taoSellerSearch#beginPage=4&offset=0
    ...
    public String urlOrigin1 = "https://s.1688.com/selloffer/offer_search.htm?descendOrder=true&sortType=va_rmdarkgmv30rt&uniqfield=userid&keywords=";
    public String urlOrigin2 = "&netType=1%2C11&n=y&from=taoSellerSearch";
    public String aliPageTag = "#beginPage=" + "placeTag" + "&offset=0";
    //    public String urlOrigin = "https://detail.1688.com/offer/539556562483.html?sk=consign";
    //    public String urlOrigin = "https://item.publish.taobao.com/sell/publish.htm?catId=50013459&itemId=592570571674";
    public String loginUrl = "https://login.1688.com/member/signin.htm?tracelog=account_verify";
    //    public String picSpaceUrl = "https://sucai.wangpu.taobao.com/?spm=a2113j.8836301.0.0.1206139dRygyV4#/manage/pic?_k=40zg4c";
    public String picSpaceUrl = "https://sucai.wangpu.taobao.com/?spm=a2113j.8836301.0.0.694f139dxs5m9o#/manage/pic?_k=umx2ua";
    public String taoGuanjiaUrl = "https://guanjia.1688.com/page/consignoffer.htm?menuCode=consignoffer";
    public String basePublish = "https://item.publish.taobao.com/sell/publish.htm?itemId=";
    public String nextUrl;
    public String aliResult = "";
    public boolean isInit = false;
    public boolean needGetJson = false;
    ...
    public ArrayList<String> skuInfo;
    public ArrayList<String> skuEditPricesList;
    public ArrayList<String> skuPicInfo;
    public int skuEditPos;
    public int skuEditPicPos = 0;
    public boolean aliOneKeyPublish = false;
    public int skuEditPricesPos;
    public int skuLimit = 5;
    public int aliCurrentPage = -1;
    public int aliMaxPage = -1;
    public boolean notAuto = false;

    public boolean debug = false;
    public ArrayList<String> skuEditCountList;
    public int skuEditCountPos;
    public String[] aliResutlArray;
    public boolean recordAvailable = true;
    public boolean uploadCheck;
    public boolean cacheAvailable = true;
    public MainActivity activity;
    public Long singleSpaceTime;
    public String fullDateFromat;
    public int guanjiaSearchErrorIndex = -1;
    public String[] titlResultArray;
...
//                webView.loadUrl(JsUtils.addJsMethod("editSKuPic(\"" + skuEditPicPos + "\")"));
            ...
            case R.string.slide_record_switch://开关活动记录
                if (webView instanceof MyWebView) {
                    ...
                    ((MyWebView) webView).setNeedDraw(!((MyWebView) webView).isNeedDraw());
                    ToastUtils.showToast(((MyWebView) webView).isNeedDraw() ? "开启" : "关闭");
                }
                break;
...
//                }
    ...
    private void clickRecord(String picSpacePasteClickDownX, String picSpacePasteClickDownY) {
        if (webView instanceof MyWebView) {
            if (!((MyWebView) webView).isClickRecord()) {
                ((MyWebView) webView).setClickRecord(true);
                ((MyWebView) webView).setSlideRecord(false);
                ToastUtils.showToast("点击记录开启");
                return;
            }
            if (((MyWebView) webView).isNeedDraw()) {
                SharedPreferencesUtils.putValue(picSpacePasteClickDownX, ((MyWebView) webView).getACTION_CLICK_DOWN_X() + "");
                SharedPreferencesUtils.putValue(picSpacePasteClickDownY, ((MyWebView) webView).getACTION_CLICK_DOWN_Y() + "");
            }
...
//                                    autoFragmentClick(R.string.set_title);
    ...
    private void webScrollToEnd() {
        if (webView instanceof MyWebView) {
            webView.scrollTo(0, ((MyWebView) webView).getScrollYRange());
        }
    }
