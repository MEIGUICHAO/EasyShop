...
//    店查查 词可查关键词
    ...
    String BRAND_CLICK_X = "BRAND_CLICK_X";
    String BRAND_CLICK_Y = "cBRAND_CLICK_Y";
    String PRODUCT_POT_CLICK_X = "PRODUCT_POT_CLICK_X";
    String PRODUCT_POT_CLICK_Y = "PRODUCT_POT_CLICK_Y";
    String AGE_AVAILABLE_CLICK_X = "AGE_AVAILABLE_CLICK_X";
    String AGE_AVAILABLE_CLICK_Y = "AGE_AVAILABLE_CLICK_Y";
    String SEX_AVAILABLE_CLICK_X = "SEX_AVAILABLE_CLICK_X";
    String SEX_AVAILABLE_CLICK_Y = "SEX_AVAILABLE_CLICK_Y";

    String SHUAISHOU_TAOBAO_CLICK_RECORD_X = "SHUAISHOU_TAOBAO_CLICK_RECORD_X";
    String SHUAISHOU_TAOBAO_CLICK_RECORD_Y = "SHUAISHOU_TAOBAO_CLICK_RECORD_Y";
    String SHUAISHOU_PUBLISH_CLICK_RECORD_X = "SHUAISHOU_PUBLISH_CLICK_RECORD_X";
    String SHUAISHOU_PUBLISH_CLICK_RECORD_Y = "SHUAISHOU_PUBLISH_CLICK_RECORD_Y";
}
